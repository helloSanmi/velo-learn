...
interface GlobalModalsProps {
  ...
  handleAddProject: (name: string, description: string, color: string, members: string[]) => void;
  ...
  return (
    <>
      <TaskModal 
        ...
        onSubmit={(title, description, priority, tags, dueDate, assigneeId) => 
          createTask(title, description, priority, tags, dueDate, activeProjectId || 'p1', assigneeId)
        } 
      />
      ...
      <VoiceCommander
        isOpen={isVoiceCommanderOpen}
        onClose={() => setIsVoiceCommanderOpen(false)}
        tasks={tasks}
      />
