...
export interface Notification {
  ...
  timestamp: number;
  read: boolean;
  linkId?: string; // ID of the task or project related to the notification
}

const NOTIFICATIONS_KEY = 'cloudtasks_notifications';
...
export const notificationService = {
  ...
  addNotification: (notification: Omit<Notification, 'id' | 'read' | 'timestamp'>): void => {
    try {
      ...
      // Trigger global event for real-time UI updates
